...
public class SearchByFilterController implements Callback< List<SearchResultDataHolder>> {
    ...
    public SearchByFilterController(Context context, RetrofitViewModel retrofitViewModel) {
        this.context = context;
        this.retrofitViewModel = retrofitViewModel;
        progressDialog = new ProgressDialog(context);
    }

    public void start(SearchQueryDataModel query, int stateId) {
        ...
        Call<List<SearchResultDataHolder>> call = apiService.SearchTrades(query, stateId);
        call.enqueue(this);
        progressDialog.setMessage("لطفا صبر کنید...");
        progressDialog.setCancelable(false);
        progressDialog.show();

        Log.e("startDate",query.getStartDate() );
        Log.e("endDate",query.getEndDate() );
        Log.e("MunZone", String.valueOf(query.getMunZone()));
        Log.e("treatyType", String.valueOf(query.getTreatyType()));
    }
